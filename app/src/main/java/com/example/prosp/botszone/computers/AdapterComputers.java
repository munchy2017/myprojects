...
import com.example.prosp.botszone.clothes.DataClothes;

import java.util.Collections;
import java.util.List;

public class AdapterComputers extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private LayoutInflater inflater;
    List<DataComputers> data = Collections.emptyList();
    DataComputers current;
    int currentPos = 0;

    // create constructor to innitilize context and data sent from MainActivity
    public AdapterComputers(Context context, List<DataComputers> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        com.example.prosp.botszone.computers.AdapterComputers.MyHolder holder = new com.example.prosp.botszone.computers.AdapterComputers.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final com.example.prosp.botszone.computers.AdapterComputers.MyHolder myHolder = (com.example.prosp.botszone.computers.AdapterComputers.MyHolder) holder;
        final DataComputers current = data.get(position);
