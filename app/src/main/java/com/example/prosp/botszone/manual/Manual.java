...
import com.example.prosp.botszone.categories.all.AdapterFish;
...
public class Manual extends AppCompatActivity {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(Manual.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterFish(Manual.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(Manual.this));

            } catch (JSONException e) {
                Toast.makeText(Manual.this, e.toString(), Toast.LENGTH_LONG).show();
            }
