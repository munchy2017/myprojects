...
public class allstaff extends AppCompatActivity {
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(allstaff.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://10.0.2.2/botszone/all_items.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                mAdapter = new AdapterFish(allstaff.this, data);
                mRVFishPrice.setAdapter(mAdapter);
                mRVFishPrice.setLayoutManager(new LinearLayoutManager(allstaff.this, LinearLayoutManager.HORIZONTAL,false));
                //horizontal list
                ...
                Toast.makeText(allstaff.this, e.toString(), Toast.LENGTH_LONG).show();
            }
